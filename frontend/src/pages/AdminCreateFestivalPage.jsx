...
export default function AdminCreateFestivalPage() {
    ...
    const regions = [
        ...
        "경기도", "강원특별자치도", "충청북도", "충청남도", "경상북도", "경상남도",
        "전북특별자치도", "전라남도", "제주특별자치도",
    ];
    const categories = ["물놀이", "여름", "가족과함께", "야행", "문화예술", "공연"];
            ...
            <Form onSubmit={handleSubmit}>
                <Row className="mb-3">
                    <Form.Group as={Col} controlId="formGridName">
                        <Form.Label>축제명 <span className="text-danger">*</span></Form.Label>
                        <Form.Control type="text" name="name" value={festivalData.name} onChange={handleInputChange} required />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridLocation">
                        <Form.Label>개최 장소 <span className="text-danger">*</span></Form.Label>
                        <Form.Control type="text" name="location" value={festivalData.location} onChange={handleInputChange} required />
                    </Form.Group>
                </Row>

                <Form.Group className="mb-3" controlId="formShortDescription">
                    <Form.Label>한 줄 소개</Form.Label>
                    <Form.Control as="textarea" rows={1} name="short_description" value={festivalData.short_description} onChange={handleInputChange} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formDescription">
                    <Form.Label>축제 설명</Form.Label>
                    <Form.Control as="textarea" rows={3} name="description" value={festivalData.description} onChange={handleInputChange} />
                </Form.Group>

                <Row className="mb-3">
                    <Form.Group as={Col} controlId="formStartDate">
                        <Form.Label>시작일</Form.Label>
                        <Form.Control type="date" name="start_date" value={festivalData.start_date} onChange={handleInputChange} />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formEndDate">
                        <Form.Label>종료일</Form.Label>
                        <Form.Control type="date" name="end_date" value={festivalData.end_date} onChange={handleInputChange} />
                    </Form.Group>
                </Row>
                ...
                <Row className="mb-3">
                    <Form.Group as={Col} controlId="formPrice">
                        ...
                        <Form.Control type="text" name="price" value={festivalData.price} onChange={handleInputChange} />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formOwner">
                        <Form.Label>주체 기관</Form.Label>
                        <Form.Control type="text" name="owner" value={festivalData.owner} onChange={handleInputChange} />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formContact">
                        <Form.Label>연락처</Form.Label>
                        <Form.Control type="text" name="contact" value={festivalData.contact} onChange={handleInputChange} />
                    </Form.Group>
                </Row>

                <Form.Group className="mb-3" controlId="formWebsite">
                    <Form.Label>공식 홈페이지</Form.Label>
                    <Form.Control type="url" name="website" value={festivalData.website} onChange={handleInputChange} />
                </Form.Group>
                ...
                <Row className="mb-3">
                    <Form.Group as={Col} controlId="formRegion">
                        <Form.Label>지역 <span className="text-danger">*</span></Form.Label>
                        <Form.Select name="region" value={festivalData.region} onChange={handleInputChange} required>
